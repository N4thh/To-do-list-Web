...
export default function LoginPage() {
  ...
  <>
    ...
    <div className="min-h-screen flex items-center justify-center">
      <div
        className="bg-white text-black w-[80%] h-[70vh] mx-auto shadow-lg rounded-lg py-24 text-2xl 
      ...
      >
        ...
        <div className="md:w-1/2 w-full p-8">
          ...
          >
            ...
            {/* UserName */}
            <input
              className="w-full px-3 py-5 border border-gray-400 rounded-md focus:outline-none focus:ring-2 focus:ring-[#FF6767]"
              name="userName"
              type="text"
